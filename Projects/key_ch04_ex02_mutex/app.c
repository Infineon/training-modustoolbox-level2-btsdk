...
void Fast_LED_thread( uint32_t );
void Slow_LED_thread( uint32_t );


/*******************************************************************
 * Global/Static Variables
 ******************************************************************/
wiced_thread_t * Fast_LED_thread_handle;
wiced_thread_t * Slow_LED_thread_handle;
...
wiced_result_t app_bt_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:						// Bluetooth Controller and Host Stack Enabled
        ...
        {		
			...
			Fast_LED_thread_handle = wiced_rtos_create_thread();
			wiced_rtos_init_thread(
					Fast_LED_thread_handle,		// Thread handle
					4,                			// Medium Priority
					"Fast LED Thread",			// Name
					Fast_LED_thread,			// Function
					1024,						// Stack space for the Fast_LED_thread function to use
					NULL );						// Function argument (not used)
					
			Slow_LED_thread_handle = wiced_rtos_create_thread();
			wiced_rtos_init_thread(
					Slow_LED_thread_handle,		// Thread handle
					4,                			// Medium Priority
					"Slow LED Thread",			// Name
					Slow_LED_thread,			// Function
					1024,						// Stack space for the Slow_LED_thread function to use
					NULL );						// Function argument (not used)
        }
        break;
...
/*******************************************************************************
* Function Name: void Fast_LED_thread(uint32_t)
********************************************************************************/
void Fast_LED_thread( uint32_t arg )
{
    while(1)
    {
...
/*******************************************************************************
* Function Name: void Slow_LED_thread(uint32_t)
********************************************************************************/
void Slow_LED_thread( uint32_t arg )
{
	while( 1 )
	{
